...
the current UTC day, and that per-link per-day number is all the service stores about a
click (`docs/adr/0004`, `0014`); deleting a link deletes its counts. The stats page and the
