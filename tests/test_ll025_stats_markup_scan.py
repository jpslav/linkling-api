...
LOADS = {
    ...
    "three slashes": '<img src="///evil.example/x.png">',
    "slash, backslash, slash": '<img src="/\\/evil.example/x.png">',
    "extra slashes after the scheme": '<img src="https:////evil.example/x.png">',
